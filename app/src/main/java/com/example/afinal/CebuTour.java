...
public class CebuTour extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cebuTourBackButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(CebuTour.this, Package.class);
        ...
        btnBookNowCebutour.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(CebuTour.this, Booking.class);
                intent.putExtra("userEmail",email);
                startActivity(intent);
            }
        });
